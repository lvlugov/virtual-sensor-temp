...
| 2 | `conditional_rules.yaml` | `coating_system_age_degradation` source | Data dictionary; API 583 coating age rule | | | `pending` | |
...
| 43 | `synthetic_inputs_methodology.md` | §6 Tier 1 coating row | API 583 coating age; EPOXY_AGED at generation | | | `pending` | |
